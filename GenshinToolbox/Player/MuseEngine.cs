...
public class MuseEngine
{
	...
	public static List<MXMlConf> InitConfs()
	{
		return new List<MXMlConf>
		{
			...
			//Coffin_dance_Piano_Easy
			new MXMlConf {
				Path = SongPath + "Coffin_Dance_-_Astronomia.mxl" ,
				Link = "https://musescore.com/user/38847862/scores/6804330", // ( https://musescore.com/user/26200776/scores/6107083 )
				TargetLength = new TimeSpan(0, 0, 22),
				MeasureEnd = 23,
				Transpose = Transpose.F2,
				Autoscale = new()
				{
